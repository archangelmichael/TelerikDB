...
namespace EntityFrameworkNorthwindModel
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncom(Nullable<int> start_date, Nullable<int> end_date, string company_name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncom", start_dateParameter, end_dateParameter, company_nameParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncoma(Nullable<int> start_date, Nullable<int> end_date, string company_name)
        {
            var start_dateParameter = start_date.HasValue ?
                new ObjectParameter("start_date", start_date) :
                new ObjectParameter("start_date", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncoma", start_dateParameter, end_dateParameter, company_nameParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncomeByName(Nullable<System.DateTime> start_date, Nullable<System.DateTime> end_date, string company_name)
        {
            var start_dateParameter = start_date.HasValue ?
                new ObjectParameter("start_date", start_date) :
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncomeByName", start_dateParameter, end_dateParameter, company_nameParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncomf(Nullable<int> start_date, Nullable<int> end_date, string company_name)
        {
            var start_dateParameter = start_date.HasValue ?
                new ObjectParameter("start_date", start_date) :
                new ObjectParameter("start_date", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncomf", start_dateParameter, end_dateParameter, company_nameParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> usp_FindTotalIncoms(Nullable<int> start_date, Nullable<int> end_date, string company_name)
        {
            var start_dateParameter = start_date.HasValue ?
                new ObjectParameter("start_date", start_date) :
                new ObjectParameter("start_date", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("usp_FindTotalIncoms", start_dateParameter, end_dateParameter, company_nameParameter);
        }
    }
}
