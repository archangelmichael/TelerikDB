namespace _08.CreateXMLfromXML
{
    using System;
    using System.Text;
    using System.Xml;
     ...
     * reads the file catalog.xml 
     * and creates the file album.xml, 
     * in which stores in appropriate way the names of all albums and their authors.     */

    public class XMLtoXMLCreator
    {
        private static string inputPath = "../../../catalogue.xml";

        private static string outputPath = "../../albums.xml";
